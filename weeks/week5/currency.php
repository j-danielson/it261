...
<body>
   ...
   <form action="<?php echo htmlspecialchars($_SERVER ['PHP_SELF']);?>" method="post">
        ...
        euros = 1.14;
        yen = 0.0087; -->
        <!-- The logic behind the stickiness in our radio button is if post currency is set and if currency = value, echo checked = checked -->
    ...
    <?php
        // if name is not filled out, gice me a message
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if(isset($_POST['name'], $_POST['email'], $_POST['amount'],$_POST['currency'],$_POST['bank'],)) {
                ...
                <p>And this will equal to '.number_format($total, 2).' American Dollars</p>
