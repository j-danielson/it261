...
$nav['index.php'] = 'Home';
    ...
    $nav['daily-genres.php'] = 'Daily Genre';
    $nav['form.php'] = 'Subscribe Now!';
    $nav['list.php'] = 'Top Records';
...
switch($today){
    case 'Sunday' : 
        $dayheader = '<h2>Sunday is for R&B</h2>';
            $pic = 'aretha_franklin.jpg';
            $alt = 'Aretha Franklin';
            $cap = 'Aretha Franklin (Queen of Soul) defined what R&B is today';
            $content ="<b>Rhythm and blues</b>, frequently abbreviated as <b>R&B</b> or <b>R'n'B</b>, is a genre of popular music that originated in African-American communities in the 1940s. The term was originally used by record companies to describe recordings marketed predominantly to urban African Americans, at a time when \"urbane, rocking, jazz based music with a heavy, insistent beat\" was becoming more popular. In the commercial rhythm and blues music typical of the 1950s through the 1970s, the bands usually consisted of piano, one or two guitars, bass, drums, one or more saxophones, and sometimes background vocalists. R&B lyrical themes often encapsulate the African-American experience of pain and the quest for freedom and joy, as well as triumphs and failures in terms of relationships, economics, and aspirations.<br> 
    ...
    case 'Monday' : 
        $dayheader = '<h2>Monday is for Pop</h2>';
        $pic = 'the_beatles.png';
        $alt = 'The Beatles';
    ...
    case 'Tuesday' : 
        $dayheader = '<h2>Tuesday is for Rock</h2>';
        $pic = 'rocket_88.jpg';
        $alt = 'Rocket 88';
    ...
    case 'Friday' : 
        $dayheader = '<h2>Friday is for Country</h2>';
            $pic = 'johnny_cash.jpg';
            $alt = 'Johnny Cash';
            ...
            $content ="<b>Country</b> (also called <b>country and western</b>) is a genre of popular music that originated with blues, church music such as Southern gospel and spirituals, old-time, and American folk music forms including Appalachian, Cajun, Creole, and the cowboy Western music styles of New Mexico, Red Dirt, Tejano, and Texas country. Its popularized roots originate in the Southern and Southwestern United States of the early 1920s. <br>
            Country music often consists of ballads and dance tunes with generally simple forms, folk lyrics, and harmonies often accompanied by string instruments such as banjos, electric and acoustic guitars, steel guitars (such as pedal steels and dobros), and fiddles as well as harmonicas. Blues modes have been used extensively throughout its recorded history.<br> 
            The term country music gained popularity in the 1940s in preference to hillbilly music; it came to encompass Western music, which evolved parallel to hillbilly music from similar roots, in the mid-20th century. In 2009, in the United States, country music was the most listened to rush hour radio genre during the evening commute, and second most popular in the morning commute. <br>
    ...
    case 'Saturday' : 
        $dayheader = '<h2>Saturday is for Metal</h2>';
